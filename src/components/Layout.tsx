...
export function MarketingShell() {
  ...
  return (
    <div className="grain-overlay relative min-h-[100dvh] w-full max-w-full overflow-x-hidden">
      <AmbienceCanvas />
      <MarketingNav />
...
export function AppShell() {
  ...
  return (
    <div className="grain-overlay relative min-h-[100dvh] w-full max-w-full overflow-x-hidden">
      <AmbienceCanvas />
      <AppRail />
      <main className="tv-safe relative z-10 min-h-[100dvh] w-full max-w-full overflow-x-hidden px-16 pb-104 pt-32 lg:pl-[112px] md:pr-28 md:pb-56 xl:pl-[136px] xl:pr-48">
